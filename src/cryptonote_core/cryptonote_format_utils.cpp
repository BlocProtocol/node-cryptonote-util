...
namespace cryptonote
{
  ...
  {
    if (BLOCK_MAJOR_VERSION_1 == bl.major_version || bl.major_version >= BLOCK_MAJOR_VERSION_5)
      return false;
  ...
  {
    if (bl.major_version >= BLOCK_MAJOR_VERSION_2 && bl.major_version < BLOCK_MAJOR_VERSION_5)
      return false;
